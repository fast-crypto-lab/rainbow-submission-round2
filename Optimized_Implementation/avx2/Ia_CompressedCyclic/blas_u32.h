...
static inline
void _gf256v_add_u32( uint8_t * accu_b, const uint8_t * a , unsigned _num_byte ) {
...
static inline
void _gf256v_predicated_add_u32( uint8_t * accu_b, uint8_t predicate , const uint8_t * a , unsigned _num_byte ) {
...
static inline
void _gf16v_mul_scalar_u32( uint8_t * a, uint8_t gf16_b , unsigned _num_byte ) {
	unsigned n_u32 = _num_byte >> 2;
...
static inline
void _gf256v_madd_u32( uint8_t * accu_c, const uint8_t * a , uint8_t gf256_b, unsigned _num_byte ) {
	unsigned n_u32 = _num_byte >> 2;
	uint32_t * c_u32 = (uint32_t *)accu_c;
	const uint32_t * a_u32 = (const uint32_t *)a;
...
static inline
uint8_t _gf16v_dot_u32( const uint8_t * a, const uint8_t * b , unsigned _num_byte ) {
	unsigned n_u32 = _num_byte >> 2;
	const uint32_t * a_u32 = (const uint32_t *)a;
